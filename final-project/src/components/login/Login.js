...
<<<<<<< HEAD
               ...
               <div className="login-wrapper">
                  ...
                  <div className="input-group">
                     ...
                     <input type="text" className="form-control" placeholder="Username" id="username" value={this.state.username} onChange={this.onChangeUsername} />
                  </div>
                  ...
                  <div className="input-group mb-2">
                     ...
                     <input type="password" className="form-control" placeholder="Password" id="password" value={this.state.password} onChange={this.onChangePassword} />
                  </div>
